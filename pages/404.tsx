...
export default function Custom404() {
	...
	return (
		<div className="relative flex flex-col justify-center items-center">
			...
			<button type="button" className="mt-10 bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded transition-colors focus:outline-none focus:ring focus:ring-blue-300">
				<Link href="/">
					Return to home.
				</Link>
			</button>
